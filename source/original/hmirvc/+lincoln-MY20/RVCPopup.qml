...
RVCBasePopup {
    ...
    rootPopupContents: Item {
        ...
        ParkAidSwitch {
            ...
            anchors.topMargin: UiTheme.styleRoot.generalMarginMedium
            anchors.leftMargin: parkingSwitchLeftMargin()
            cameraScreen:true
            showLabel:false
            ...
            onToggleButtonClicked:{
                //Send the Request to turn ON or Off BPA
